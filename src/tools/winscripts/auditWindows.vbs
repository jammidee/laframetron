...
'url = "http://localhost:3101/global/master/noblink/xmlsource"
...
if debugging > "0" then
	...
	wscript.echo "create_filename      " & create_filename
        ...
        if ldap > "" then
            ...
            if objRecordSet.RecordCount > 0 then
                ...
                if (create_file = "y" and hit = 1) then
					...
					'-------------------------------------------------------------
					'Added by Jammi Dee 07/29/2019
					if create_filename <> "" then OutputFile = create_filename
					'-------------------------------------------------------------
