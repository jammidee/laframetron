 ...
 *
 * File Create Date: 01/25/2024 07:33am
...
function createLteWindow( mainWindow, glovars ) {
  ...
  newWindow.on('close', (event) => {
    ...
    console.log('AdminLTE Window is closing');
...
module.exports = { createLteWindow };
